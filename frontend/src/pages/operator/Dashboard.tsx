...
const mockAreaReports = [
  {
    id: 1,
    operator: "Sara Martínez",
    estado: "Abierto",
    prioridad: "Alta",
    tipo: "Falla eléctrica",
    descripcion: "Motor de la banda transportadora no enciende. Se escuchó un sonido de chispa antes de apagarse.",
    area: "Producción",
    fecha: "28/04/2026",
    hora: "08:30",
  },
  {
    id: 2,
    operator: "Marcos Nodal",
    estado: "Asignado",
    prioridad: "Media",
    tipo: "Sobrecalentamiento",
    descripcion: "Temperatura elevada en el panel de control de la línea 3.",
    area: "Producción",
    fecha: "24/04/2026",
    hora: "11:21",
  },
  {
    id: 3,
    operator: "Elena Rodríguez",
    estado: "En proceso",
    prioridad: "Baja",
    tipo: "Vibración Excesiva",
    descripcion: "Vibración anormal en bomba de enfriamiento. Se detectó durante la inspección matutina.",
    area: "Producción",
    fecha: "21/04/2026",
    hora: "07:47",
  },
...
function PrioridadBadge({ prioridad }: { prioridad: string }) {
  ...
  return (
    <span style={{ fontSize: 12, fontWeight: 600, color: s.color }}>{prioridad}</span>
  );
}
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <div style={{ textAlign: "right" }}>
            ...
            <div style={{ color: "#9ca3af", fontSize: 12 }}>Operador</div>
          </div>
          <button style={{
      ...
      <div style={{ padding: "32px 32px 0" }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex" }}>
            {[
              { key: "area", label: "Reportes de área" },
              { key: "mine", label: "Tus reportes" },
            ].map(tab => (
              <button
                key={tab.key}
